...
#31 MAY2023 i)re installed the canbus tools for the new version of ubuntu
#           ii) the float value is taken for the position calculation in ODrive helper function. 
#6 JUN 2023 i)2 wheel ackermann steering with the IMU controls on line no. 728
...
def AutomaticControlMode():
   ...
   ForwardMovement=3000
   BackwardMovement=-3000
