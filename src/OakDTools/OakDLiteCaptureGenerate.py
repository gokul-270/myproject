...
with dai.Device(pipeline) as device:
    ...
    try:
        ...
        from projector_deviceWithOutVisualiser import PointCloudVisualizer
        ...
        for q in qs:
            ...
            if new_msg is not None:
                ...
                if msgs:
                    ...
                    i=i-1
                    if i == 0:
                        #pcl_converter.write_pointcloud("points100.pcd")
                        #cv2.imwrite("points100.jpg",color)
                        pcl_converter.write_pointcloud(PCDFILEPATH) 
                        #pcl_converter.write_pointcloud("points.pcd") 
                        cv2.imwrite(IMG100FILEPATH, color)
                        exit()
