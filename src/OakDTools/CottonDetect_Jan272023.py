...
COTTONDETAILSUNSORTFILEPATH = "/home/ubuntu/pragati/outputs/CottonCoordinatesUnsorted.txt"
COTTONDETAILSSORTFILEPATH = "/home/ubuntu/pragati/outputs/CottonCoordinatesSorted.txt"
...
def main():
    ...
    CleanUpFile(COTTONDETAILSSORTFILEPATH)
    CleanUpFile(COTTONDETAILSUNSORTFILEPATH)
...
#  with dai.Device(pipeline) as device:
        ...
        while True:
            ...
            if (DetectionOutputRequired == True):
               ...
               if (IMAGELOGGING == False): 
                  print("Removing the pragati I/O Directory")
                  CleanUpFile(IMG100FILEPATH)
                  CleanUpFile(DETECTIONOUTPFILEPATH)
                  CleanUpFile(COTTONDETAILSTXTFILEPATH)
                  CleanUpFile(COTTONDETAILSSORTFILEPATH)
